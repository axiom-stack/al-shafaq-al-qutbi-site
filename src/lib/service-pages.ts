...
export const servicePageConfigs: Record<ServiceSlug, ServicePageConfig> = {
  "sea-freight": {
    ...
    capabilityKeys: ["lcl", "fcl", "bulkPartial", "monitoring", "specialized"],
    capabilityIcons: {
      lcl: "layers",
      fcl: "box",
      bulkPartial: "box",
  ...
  "land-freight": {
    ...
    capabilityKeys: ["ftl", "ltl", "flatbed", "temperature", "regional"],
    capabilityIcons: {
      ftl: "truck",
      ltl: "layers",
      flatbed: "route",
  ...
  "air-freight": {
    ...
    capabilityKeys: ["handling", "timeSensitive", "delicate", "updates", "schedule"],
    capabilityIcons: {
      handling: "box",
      timeSensitive: "speed",
      delicate: "spark",
  ...
  "cargo-consolidation": {
    ...
    capabilityKeys: ["grouping", "container", "cost", "organization", "supplyChain"],
    capabilityIcons: {
      grouping: "box",
      container: "layers",
      cost: "flex",
  ...
  warehousing: {
    ...
    capabilityKeys: ["secure", "management", "inventory", "protection", "flexible"],
    capabilityIcons: {
      secure: "shield",
  ...
  "customs-clearance": {
    ...
    capabilityKeys: ["documentation", "compliance", "faster", "coordination", "crossBorder"],
    capabilityIcons: {
      documentation: "quote",
      compliance: "customs",
      faster: "speed",
